...
public class Main
{
    public static void main(String[] args)
    {
        ...
        System.out.println("===================================");
        Mission<SoldierMission> sm = new Mission("SoldieMission", new Point(2,4));
        sm.aim = new SoldierMission();
...
class Mission<T>
{
    ...
    @Override
    public String toString() {
        return "Название миссии: " + missionName + "\nСтатус: " + successful +
                "\nПоложение солдата: " + unitPosition + "\nAim: " + aim;
    }
}
...
class SoldierMission
{
    Rect aim;

    public SoldierMission()
    {

        aim = new Rect();
    }

    public SoldierMission(Rect aim)
    {
